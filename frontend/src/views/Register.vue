      ...
      <div class="container pt-5">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6" data-aos="fade-right">
            <div class=" h1 font-weight-bold v-text-warning">Sign Up</div>
            ...
            <div class="form-row">
              ...
              <div class="col-lg-6 pt-4">
                ...
                <select
                  id="jurusan"
                  v-model="registerData.jurusan"
                  class="form-control border-left-0 border-top-0 border-right-0"
                >
                  <option value="TKJ">Teknologi Komputer & Jaringan</option>
  ...
  methods: {
    register() {
      axios
        ...
        .then((result) => {
          if (result.msg == "1 Data Recorded" && result.status == "admin") {
